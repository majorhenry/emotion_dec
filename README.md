...
The Google GoEmotions dataset is a large-scale, fine-grained emotion classification system developed by Google Research. It contains over 5,8009 English Reddit comments annotated for 27 emotion categories and a neutral category. The emotions include common ones like joy, sadness, and anger, as well as more nuanced ones like admiration, caring, and embarrassment. This project focuses on training and evaluating the trained model to understand emotional expression in text.
...
This maps port 8501 on the local machine to port 8501 in the Docker container, where Streamlit serves the app.
